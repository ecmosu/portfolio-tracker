    ...
    async handleSignupSubmit(event) {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                this.props.appState.onStatusMessageChange(true, (<div><strong>Alert!</strong> An unknown error was encountered while attempting to register.</div>));
            }
        }
        catch
        {
        ...
        return (
            <Card className="mt-3">
                <CardBody>
                    ...
                    <h4 className="card-subtitle mb-2 text-muted">Register Account</h4>
